...
<ul class="list-unstyled display hidden-xs hidden-md hidden-sm">
    ...
    <li id="grid"><a data-toggle="tooltip" rel="nofollow" href="#" title="{l s='Grid'}"><i class="icon-th"></i><span>{l s='Grid'}</span></a></li>
    <li id="list"><a data-toggle="tooltip" rel="nofollow" href="#" title="{l s='List'}"><i class="icon-list-ul"></i><span>{l s='List'}</span></a></li>
</ul>
