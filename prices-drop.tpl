...
{capture name=path}{l s='Акции и скидки'}{/capture}

<h1 class="page-heading product-listing">{l s='Акции и скидки'}</h1>
...
{else}
	<p class="alert alert-warning">{l s='No Акции и скидки'}</p>
{/if}
