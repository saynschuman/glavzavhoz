...
<h4>Отзывы о {$product->name|escape:'html':'UTF-8'}</h4>
	...
	<div class="reviews-loop">
		<div class="review clearfix">
			<div class="left">
				<div class="reviewer-name">Алексей</div>
				<div class="review-date">2017-07-24</div>
				<div class="review-mark">Оценка</div>
			...
			<div class="right">
				<div class="reason"><i class="fa fa-plus" aria-hidden="true"></i><span>Приобретали для снабжения офиса</span></div>
				<div class="review-content"><i class="fa fa-comment-o" aria-hidden="true"></i><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean euismod bibendum laoreet. Proin gravida dolor sit amet lacus accumsan et viverra justo commodo. Proin sodales pulvinar tempor. </p></div>

			    <nav class="button-share-container"> 
			    	<a target="_blank" href="https://twitter.com/intent/tweet?text=La+mirada+de+Snakeyephoto&url=https://www.surfsearchspot.com/?p=16024" class="buttons" tooltip="Comparte en Twitter"> <i class="fa fa-twitter"></i> </a>
			    	...
			    	<a target="https://plus.google.com/share?url=https://www.surfsearchspot.com/?p=16024" href="#" class="buttons" tooltip="Comparte en Google Plus"> <i class="fa fa-google-plus"></i> </a>

			    	<a target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&url=https://www.surfsearchspot.com/?p=16024" class="buttons" tooltip="Comparte en LikenIn"> <i class="fa fa-linkedin-square"></i> </a>


			    	<a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https://www.surfsearchspot.com/?p=16024" class="buttons" tooltip="Comparte en Facebook"> <i class="fa fa-facebook"></i> </a>


			    	<a class="share-link"  href="#" onClick="return false;" tooltip="Comparte">     
		...
		<div class="review clearfix">
			<div class="left">
				<div class="reviewer-name">Дмитрий Игоревич</div>
				<div class="review-date">2017-07-24</div>
				<div class="review-mark">Оценка</div>
				<ul class="star-raiting">
					<li><a href=""><i class="fa fa-star" aria-hidden="true"></i></a></li>
			...
			<div class="right">
				<div class="reason"><i class="fa fa-plus" aria-hidden="true"></i><span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean euismod bibendum laoreet. Proin gravida dolor sit amet lacus accumsan et viverra justo commodo.</span></div>
				<div class="review-content"><i class="fa fa-comment-o" aria-hidden="true"></i><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p></div>
			    <nav class="button-share-container"> 
			    	<a target="_blank" href="https://twitter.com/intent/tweet?text=La+mirada+de+Snakeyephoto&url=https://www.surfsearchspot.com/?p=16024" class="buttons" tooltip="Comparte en Twitter"> <i class="fa fa-twitter"></i> </a>
