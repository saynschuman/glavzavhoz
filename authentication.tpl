...
{else}
	...
	<p class="terms">Нажимая кнопку "Регистрация" я даю согласие на обработку персональных данных в соответствии с <a href="/polzovatelskoe-soglashenie" target="_blank">пользовательским соглашением</a></p>
{/if}
{strip}
...
<div class="auth-wrapper">
	<div class="auth-block">
		<!-- Nav tabs -->
		<div id="auth-tabs-header-wrapper">
			<ul id="auth-tabs-header" class="nav nav-tabs nav-justified indigo" role="tablist">
			    <li class="nav-item active">
			        <a class="nav-link active" data-toggle="tab" href="#panel5" role="tab"><i class="fa fa-user"></i> Вход</a>
			    </li>
			    <li class="nav-item">
			        <a class="nav-link" data-toggle="tab" href="#panel6" role="tab"><i class="fa fa-user-plus"></i> Регистрация</a>
			    </li>
			</ul>
		</div>
		<!-- Tab panels -->
