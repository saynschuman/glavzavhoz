...
<ul class="footer_links list-unstyled clearfix">
	...
	<li class="pull-right"><a class="btn btn-default button button-medium button-small" href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}"><span><i class="icon-chevron-left left"></i> {l s='Home'}</span></a></li>
</ul>
