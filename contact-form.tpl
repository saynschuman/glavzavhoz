...
<div class="row contacts-content">
						<table>
							<tbody>
							<tr>
									<td class="left-col">Наименование</td>
									<td>ООО "ТОЧКА РУ"</td>
								</tr>
							
							
								<tr>
									<td class="left-col">Свяжитесь с нами</td>
									<td>Телефон в Санкт-Петербурге<span class="str1">+7(812)320-04-05</span><br>
									Электронная почта<span class="str2">mail@glavzavhoz.ru</span></td>
								</tr>
								<tr>
									<td class="left-col">Адрес</td>
									<td>191119, город Санкт-Петербург, Роменская улица, дом 8, литера А, помещение 2-Н</td>
								</tr>
								<tr>
									<td class="left-col">Реквизиты</td>
									<td>ИНН 7801532391<br>КПП 784201001<br>ОГРН 1107847367891</td>
								</tr>
							</tbody>
						</table>
						<script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=JYs0614CusP5zSZ5dhN7ZH4MlenbeIAl&amp;width=100%25&amp;height=490&amp;lang=ru_RU&amp;sourceType=constructor&amp;scroll=true"></script>
				</div>
			</div>
		</section>
...
{if isset($confirmation)}
	...
	<ul class="footer_links list-unstyled clearfix">
		<li>
            <a class="btn-default button btn" href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}">
                <span>
...
{else}
    ...
    <p class="terms">Нажимая кнопку "Отправить" я даю согласие на обработку персональных данных в соответствии с <a href="/polzovatelskoe-soglashenie" target="_blank">пользовательским соглашением</a></p>
{/if}
